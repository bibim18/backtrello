...
var BaseRepository = /** @class */ (function () {
    ...
    BaseRepository.prototype.find = function (query, paginate) {
        if (query === void 0) { query = {}; }
        if (paginate === void 0) { paginate = {}; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this.model.paginate && (paginate.page !== undefined && paginate.limit !== undefined))) return [3 /*break*/, 2];
                        if (paginate.page < 1)
                            throw new Error('page start with 1');
                        return [4 /*yield*/, this.model.paginate(query, {
                    ...
                    case 2: return [4 /*yield*/, this.model.find(query)];
                    case 3:
                        result = _a.sent();
                        page.items = result;
    ...
    BaseRepository.prototype.update = function (query, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.model.findOneAndUpdate(query, data, { new: true })];
            });
        });
    };
    BaseRepository.prototype.delete = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.model.remove(data)];
            });
        });
    };
